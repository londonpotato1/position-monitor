// Package htx provides HTX (Huobi) exchange adapter.
// HTX 인터페이스 어댑터 - OverseasExchange 구현
package htx
...
func (a *Adapter) GetPosition(ctx context.Context, symbol string) (*exchange.Position, error) {
	return a.client.GetPosition(ctx, strings.ToUpper(symbol)+"-USDT")
}
